...
const situacoesMock = [
    ...
    { value: "Aguardando Faturamento", label: "Aguardando Faturamento" },
                            ...
                            <tbody>
                                {itens.map((it, idx) => (
                                    ...
                                    >
                                        ...
                                        <td className="border px-2 py-1">{it.nfEntrada}</td>
                        ...
                        <>
                                ...
                                <fieldset className="border border-gray-300 rounded p-3 bg-white">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="grid grid-cols-12 gap-2 items-center">
                                            ...
                                            <Txt className="col-span-2" value={item.produtoCod} onChange={setI("produtoCod")} placeholder="Código" />
                                            <Txt className="col-span-4 bg-gray-200" readOnly value={item.produtoDesc} placeholder="Descrição" />
                                            <Label className="col-span-1 justify-end">Nº Lote</Label>
                                            <Txt className="col-span-2" value={item.nrLote} onChange={setI("nrLote")} />
                                        ...
                                        <div className="grid grid-cols-12 gap-2 items-center">
                                            ...
                                            <Txt type="date" className="col-span-2" value={item.validade} {...bindDateSmart(setI("validade"))} />
                                            <Label className="col-span-2 justify-end">Item Armazenado</Label>
                                            <Txt className="col-span-2 bg-gray-200 text-center" readOnly value={item.itemArmazenado} />
                                            <Label className="col-span-1 justify-end">Nº Item</Label>
                                            <Txt className="col-span-1 bg-gray-200 text-center" readOnly value={item.nrItem} />
                                            <Label className="col-span-1 justify-end">Unidade</Label>
                                            <Sel className="col-span-2" value={item.unidade} onChange={setI("unidade")}>
                                        ...
                                        <div className="grid grid-cols-12 gap-2 items-center">
                                            ...
                                            <Txt className="col-span-2 text-right" value={item.qtdItem} onChange={setI("qtdItem")} />
                                            <Label className="col-span-2 justify-end">Valor Unitário</Label>
                                            <Txt className="col-span-2 text-right" value={item.vrUnit} onChange={setI("vrUnit")} />
                                            <Label className="col-span-1 justify-end">CST</Label>
                                            <Txt className="col-span-1 text-center" value={item.cst} onChange={setI("cst")} />
                                            <Label className="col-span-1 justify-end">Total Item</Label>
                                            <Txt className="col-span-2 bg-gray-200 text-right" readOnly value={item.totalItem} />
                                        </div>

                                        {/* Linha 4 */}
                                        <div className="grid grid-cols-12 gap-2 items-center">
                                            <Label className="col-span-1 justify-end">NCM</Label>
                                            <Txt className="col-span-2 text-center" value={item.ncm} onChange={setI("ncm")} />
                                            <Label className="col-span-2 justify-end">Cor</Label>
                                            <Sel className="col-span-2" value={item.corCod} onChange={setI("corCod")} onKeyDown={onLastFieldKeyDown} ref={lastFieldRef}>
                            ...
                            <fieldset className="border border-gray-300 rounded p-3 bg-white mb-3">
                                        ...
                                        <tbody>
                                            {itens.map((it, idx) => (
                                                ...
                                                >
                                                    ...
                                                    <td className="border px-2 py-1">{it.nfEntrada}</td>
                                                    <td className="border px-2 py-1">{it.cor}</td>
                                                    <td className="border px-2 py-1 text-center">{formatDataBR(it.venc)}</td>
                                                    <td className="border px-2 py-1 text-right">{formatNumero(it.qtd)}</td>
                                                    <td className="border px-2 py-1 text-right">{formatNumero(it.vrUnit)}</td>
                                                    <td className="border px-2 py-1 text-center">{it.cst}</td>
                                                    <td className="border px-2 py-1 text-center">{it.ncm}</td>
                                                    <td className="border px-2 py-1">{it.etiqueta}</td>
                                                    <td className="border px-2 py-1 text-right">{formatNumero(it.qtdDiv)}</td>
                                                </tr>
                                            ))}

                                            {itens.length === 0 && (
                                                <tr>
                                                    <td colSpan={13} className="border px-2 py-6 text-center text-gray-500">
                                ...
                                <div className="grid grid-cols-12 gap-2 items-center mt-2">
                                    ...
                                    {/* Tipo Devolução */}
                                    <Label className="col-span-3 justify-end">
                                        Tipo Devolução
                                    </Label>
                                    <Sel
                                        className="col-span-2"
                            ...
                            <div className="border border-gray-300 rounded bg-white">
                                <div className="flex items-center justify-between px-3 py-2 border-b border-gray-300 bg-gray-50">
                                    <div className="flex items-center gap-2">
                                        ...
                                        >
                                            {isTranspOpen ? <ChevronUp size={16} className="text-red-700" /> : <ChevronDown size={16} className="text-red-700" />}
                                        </button>
                                        ...
                                        <fieldset className="border border-gray-300 rounded p-3 bg-white">
                                            ...
                                            <div className="space-y-2">
                                                <div className="grid grid-cols-12 gap-2 items-center">
                                                    ...
                                                    <Txt className="col-span-5 bg-gray-200" readOnly value={transp.transpNome} />
                                                    <Txt className="col-span-3 bg-gray-200" readOnly value={transp.transpCidade} />
                                                    <Txt className="col-span-1 bg-gray-200 text-center" readOnly value={transp.transpUF} />
                                                </div>
                                                <div className="grid grid-cols-12 gap-2 items-center">
                                                    <Label className="col-span-1 justify-end">Frete</Label>
                                                    <Sel className="col-span-2" value={transp.frete} onChange={setT("frete")}>
                                                        {freteMock.map(f => <option key={f.value} value={f.value}>{f.label}</option>)}
                                                    </Sel>
                                                ...
                                                <div className="grid grid-cols-12 gap-2 items-center">
                                                    ...
                                                    <Sel className="col-span-2" value={transp.tipoVolume} onChange={setT("tipoVolume")}>
                                                        {tipoVolumeMock.map(t => <option key={t.value} value={t.value}>{t.label}</option>)}
                                                    </Sel>
                                                    ...
                                                    <Sel className="col-span-2" value={transp.tipoProduto} onChange={setT("tipoProduto")}>
                                                        {tipoProdutoMock.map(t => <option key={t.value} value={t.value}>{t.label}</option>)}
                                                    </Sel>
                        ...
                        <>
                            ...
                            <fieldset className="border border-gray-300 rounded p-3 bg-white">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="grid grid-cols-12 gap-2 items-center">
                                        <Label className="col-span-1 justify-end">Empresa</Label>
                                        <Sel className="col-span-4" value={filtro.empresa} onChange={setF("empresa")}>
                                            {empresasMock.map((e) => (
                                                <option key={e.value} value={e.value}>{e.label}</option>
                                            ))}
                                        </Sel>
                                        ...
                                        <Label className="col-span-1 justify-end">Filial</Label>
                                        <Sel className="col-span-4" value={filtro.filial} onChange={setF("filial")} disabled={filtro.buscarTodasFiliais}>
                                            {filiaisMock.map((f) => (
                                                <option key={f.value} value={f.value}>{f.label}</option>
                                            ))}
                                        </Sel>
