...
export default function VeiculoCombustivel({ open }) {
    const navigate = useNavigate();
    const { footerIconColorNormal, footerIconColorHover } = useIconColor();

    // ---------------- MOCK
    const mock = [
        { codigo: "A", descricao: "ALCOOL" },
        { codigo: "B", descricao: "BIO DIESEL" },
        { codigo: "D", descricao: "DIESEL" },
        { codigo: "E", descricao: "ARLA" },
        { codigo: "G", descricao: "GASOLINA" },
        { codigo: "N", descricao: "NENHUM" },
    ];
    ...
    const incluir = () => {
        if (!dados.codigo || !dados.descricao) {
            alert("Informe o código e descrição!");
            return;
        }
                ...
                <div className="border border-gray-300 rounded p-3 bg-white flex flex-col gap-3">
                    ...
                    <fieldset className="border border-gray-300 rounded p-3">
                        ...
                        <div className="grid grid-cols-12 gap-2 mb-2">
                            <Label className="col-span-2">Código Combustível</Label>
                            <Txt
                        ...
                        {/* Linha 2 - Nome */}
                        <div className="grid grid-cols-12 gap-2 mb-2">
                            <Label className="col-span-2">Nome Combustível</Label>
                            <Txt
