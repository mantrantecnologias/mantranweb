...
/* ========================= Mocks ========================= */
const cargosMockBase = [
    { codigo: "001", descricao: "DIRETORIA ADMINISTRADOR" },
    { codigo: "002", descricao: "DIRETORIA" },
    { codigo: "003", descricao: "COORDENACAO" },
    { codigo: "004", descricao: "ESTAGIARIO" },
    { codigo: "005", descricao: "ADMINISTRATIVO" },
    { codigo: "006", descricao: "FINANCEIRO" },
    { codigo: "007", descricao: "OPERACIONAL" },
    { codigo: "008", descricao: "MANUTENÇÃO PARCEIRO" },
    { codigo: "009", descricao: "CONTAS A RECEBER" },
    { codigo: "010", descricao: "ASSISTENTE DE QUALIDADE" },
    { codigo: "011", descricao: "LOGISTICA" },
    { codigo: "012", descricao: "TESTE" },
];

export default function Cargo({ open }) {
    ...
    // ---------------- Estado
    const [lista, setLista] = useState(cargosMockBase);
    ...
    const incluir = () => {
        ...
        setModalMsg({
            ...
            onYes: () => {
                ...
                limpar();
                setModalMsg({ tipo: "sucesso", texto: "Cargo incluído com sucesso!" });
            },
        });
    };
    ...
    const alterar = () => {
        ...
        setLista(nova);
        limpar();
        setModalMsg({ tipo: "sucesso", texto: "Cargo alterado com sucesso!" });
    };
    ...
    const excluir = () => {
        ...
        setModalMsg({
            tipo: "confirm",
            texto: "Deseja excluir este cargo?",
            onYes: () => {
                setLista(lista.filter((_, i) => i !== editIndex));
                limpar();
                setModalMsg({ tipo: "sucesso", texto: "Cargo excluído com sucesso!" });
            },
        });
    };
                ...
                <div className="border border-gray-300 rounded p-3 bg-white flex flex-col gap-3">
                    ...
                    <fieldset className="border border-gray-300 rounded p-3">
                        ...
                        <div className="grid grid-cols-12 gap-2 mb-2">
                            <Label className="col-span-1 justify-end">Código Cargo</Label>
                            <Txt
                        ...
                        {/* Linha 2 */}
                        <div className="grid grid-cols-12 gap-2 mb-2">
                            <Label className="col-span-1 justify-end">Nome Cargo</Label>
                            <Txt
