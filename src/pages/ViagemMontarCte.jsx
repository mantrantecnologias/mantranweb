...
export default function ViagemMontarCte({ isOpen, onClose }) {
  const [modo, setModo] = useState("data"); // "data" ou "nf"

  // === Dados das notas simuladas ===
  const [notas, setNotas] = useState([
    {
      ...
      destinatario: "CERVEJARIA SERVIÇOS ADM LTDA",
      endereco: "RUA GASPAR DE LEMOS, 530",
      cidade: "SALVADOR",
      uf: "BA",
      peso: 800,
      selecionado: false,
    ...
    },
    {
      ...
      serie: "1",
      remetente: "50221019000136",
      destinatario: "HNK NORDESTE LOGÍSTICA",
    ...
    <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center">
      <div className="bg-white rounded-lg shadow-xl border border-gray-300 w-[95%] max-w-[1100px] max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="flex justify-between items-center px-4 py-2 border-b bg-gray-100">
          <h2 className="text-red-700 font-semibold text-[14px]">Pesquisa de Notas - Montar CTe</h2>
