...
// Mock de Produtos
const produtosMock = [
    { codigo: "0000", nome: "DIVERSOS" },
    { codigo: "0001", nome: "CABO" },
    { codigo: "0002", nome: "BEBIDA" },
];

function ProdutoSelecaoModal({ open, resultados, onSelect, onClose }) {
        ...
        >
            ...
            >
                <div className="bg-gray-100 px-3 py-2 border-b border-gray-300 flex justify-between items-center">
                    <span className="font-semibold text-red-700 text-[13px]">Selecione o Produto</span>
                    ...
                    <table className="w-full text-[12px] border-collapse">
                        ...
                        <tbody>
                            {resultados.map((prod, idx) => (
                                ...
                                >
                                    <td className="border-b px-3 py-1.5 font-mono">{prod.codigo}</td>
                                    <td className="border-b px-3 py-1.5">{prod.nome}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
...
export default function InputBuscaProduto({
    label = "Produto",
    value = "",
    onChange,
    onSelect,
    ...
    const handleKeyDown = (e) => {
        ...
        const filtrados = produtosMock.filter(p =>
            p.codigo.includes(termo) || p.nome.toLowerCase().includes(termo)
        );
