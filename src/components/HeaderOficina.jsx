// src/components/HeaderOficina.jsx
import {
    Bell,
    ChevronDown,
    Menu,
...
// Ícone estilo Google Apps
function AppDotsIcon({ size = 20, className = "bg-orange-700" }) {
...
export default function HeaderOficina({ toggleSidebar }) {
    ...
    // MENU RÁPIDO OFICINA
    const { atalhos } = useMenuRapidoOficina();
                                        ...
                                        >
                                            ...
                                            {!n.lido && (
                                                <button
                                                    ...
                                                    className="
    ml-2 w-6 h-6 flex items-center justify-center rounded bg-green-600 hover:bg-green-700 transition shrink-0"
                                                >
                    ...
                    <div className="relative">
                        <button
                            ...
                            onMouseLeave={handleLeave}
                        >
                            <AppDotsIcon size={18} className={iconColor.replace("text-", "bg-")} />
                        </button>

                        {showAppsMenu && (
                            <div className="absolute right-0 mt-2 w-64 bg-white rounded shadow-lg border z-50 p-3 grid grid-cols-3 gap-4">
                                {[
                                    { icon: "fa-wrench", label: "Oficina" },
                                    { icon: "fa-chart-column", label: "Indicadores" },
                                    { icon: "fa-truck-fast", label: "Frota" },
                                    { icon: "fa-clipboard-check", label: "Checklists" },
                    ...
                    <div className="relative">
                        ...
                        {showUserMenu && (
                            <div className="absolute right-0 mt-2 w-56 bg-white border rounded shadow-lg z-50 py-1">
                                ...
                                <button
                                    onClick={() =>
                                        navigate("/modulo-oficina/parametros")
                                    }
                                    className="w-full flex items-center gap-2 px-4 py-2 text-sm hover:bg-gray-100"
                                >
